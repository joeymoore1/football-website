...
//  ******** FIXTURES *********
  ...
  val shifnalImperials = Fixture("Shifnal Imperials", LocalDate.parse("2020-09-20"), "Ketley Bank")
  ...
  val fullFixtures: List[Fixture] = List(shifnalImperials, kingsArms, captainsWebb, wellingtonKB, travellersJoy)
